...
inline bool IsXKeysymKeyPad(unsigned int keysym) {
  switch (keysym) {
    case XK_KP_Delete:
    case XK_KP_Tab:
    case XK_KP_Enter:
...
inline KeyboardCode GdkEventToWindowsKeyCode(const GdkEventKey* event) {
...
inline int GetControlCharacter(KeyboardCode windows_key_code, bool shift) {
