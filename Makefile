...
BASE= rtp.o xmlrpcserver.o xmlhandler.o xmlstreaminghandler.o statushandler.o  dtls.o CPUMonitor.o OpenSSL.o RTPTransport.o   eventstreaminghandler.o httpparser.o   stunmessage.o crc32calc.o http.o avcdescriptor.o utf8.o  
